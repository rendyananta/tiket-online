											...
											<div class="card">
													<div class="header">
															...
															<div class="form-group">
																<a href="/staff/jadwal/baru" class="btn btn-success btn-fill"><span class="glyphicon glyphicon-plus"></span> Baru</a>
															</div>
                                    ...
                                    <th width="50">Tersedia</th>
																	...
																	<tbody>
																		<?php if (count($schedules) > 0): ?>
																			...
																			<tr style="cursor:pointer" onclick="redirect('/staff/jadwal/show?code=<?= $schedule['code'] ?>')">
																				<td><?= $key + 1 ?></td>
                                        ...
                                        <td><?= $schedule['price'] ?></td>
																				...
																				<td>
																					<form action="/staff/jadwal/delete" method="post">
																							<div class="form-group">
																								<input type="hidden" name="code" value="<?= $schedule['code'] ?>">
																								<a href="/staff/jadwal/edit?code=<?= $schedule['code'] ?>" class="btn btn-fill btn-default btn-sm"><span class="glyphicon glyphicon-pencil"></span> Ubah</a>
																							</div>
																							<div class="form-group">
