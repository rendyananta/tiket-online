        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
											...
											<div class="card">
													<div class="header">
															...
															<div class="form-group">
																...
																<a href="/admin/maskapai/edit?username=<?= $staff['username'] ?>" class="btn btn-success btn-fill"><span class="glyphicon glyphicon-pencil"></span>  Ubah</a>
															</div>
													</div>
													<div class="content">
                            <h3><?= $staff['name'] ?></h3>
                            ...
                            <table>
                              <tr>
                                <td width="200">Nama Staff</td>
                                <td width="30">:</td>
                                <td><?= $staff['name'] ?></td>
                              </tr>
															<tr>
																<td>Username Staff</td>
																<td>:</td>
                              ...
                              <tr>
                                ...
                                <td>:</td>
                                <td><?= date_format(date_create($staff['created_at']), "l, d F Y - H:i") ?></td>
                              </tr>
                            </table>
													</div>
											</div>
