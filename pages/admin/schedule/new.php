                ...
                <div class="row">
									<div class="col-md-8">
											<div class="card">
													...
													<div class="content">
                            <form action="/admin/jadwal/new" method="post">
                              <div class="form-group">
                                ...
                                <select class="form-control" name="airline" required>
															...
															<div class="form-group">
																...
																<input type="text" class="form-control" name="from" value="" placeholder="Asal" required>
															</div>
															<div class="form-group">
																<label for="">Kota Tujuan</label>
																<input type="text" class="form-control" name="to" value="" placeholder="Tujuan" required>
															</div>
															<div class="form-group">
																<label for="">Waktu Berangkat</label>
																<input type="text" class="form-control datetimepicker" name="departure" value="" placeholder="Tujuan" required>
															</div>
															<div class="form-group">
																<label for="">Waktu Datang</label>
																<input type="text" class="form-control datetimepicker" name="arrival" value="" placeholder="Tujuan" required>
															</div>
															<div class="form-group">
															...
															<div class="form-group">
																...
																<input type="number" class="form-control" name="capacity" value="" required>
															</div>
															<div class="clearfix"></div>
                              <div class="form-group">
                                <button type="submit" name="button" class="btn btn-warning btn-fill"><span class="glyphicon glyphicon-plus"></span> Tambahkan</button>
                              </div>
                            </form>
													</div>
											</div>
