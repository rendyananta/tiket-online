											...
											<div class="card">
													<div class="header">
															...
															<div class="form-group">
																<a href="/admin/maskapai/baru" class="btn btn-success btn-fill"><span class="glyphicon glyphicon-plus"></span> Baru</a>
															</div>
													</div>
																	...
																	<tbody>
																		<?php if (count($airlines) > 0): ?>
																			<?php foreach ($airlines as $key => $airline): ?>
																				<tr style="cursor:pointer" onclick="redirect('/admin/maskapai/show?id=<?= $airline['id'] ?>')">
																					<td><?= $key + 1 ?></td>
																					<td><?= $airline['name'] ?></td>
																					<td><?= $airline['code'] ?></td>
																					<td>
																						<form method="post" action="/admin/maskapai/delete">
																							...
																							<a href="/admin/maskapai/edit?id=<?= $airline['id'] ?>" class="btn btn-fill btn-default btn-sm"><span class="glyphicon glyphicon-pencil"></span> Ubah</a>
																		...
																		<?php else: ?>
																			<tr>
																				<td colspan="3"><center>Belum ada maskapai ditambahkan</center></td>
																			</tr>
																		<?php endif; ?>
																	</tbody>
															</table>
