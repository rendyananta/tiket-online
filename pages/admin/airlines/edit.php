                ...
                <div class="row">
									<div class="col-md-6">
											<div class="card">
													...
													<div class="content">
                            <form action="/admin/maskapai/update" method="post">
                              <input type="hidden" name="id" value="<?= $airline['id'] ?>">
                              <div class="form-group">
                                <label for="">Nama Maskapai</label>
                                <input type="text" class="form-control" name="nama" value="<?= $airline['name'] ?>" required>
                              </div>
                              <div class="form-group">
                                <label for="">Kode Maskapai</label>
                                <input type="text" class="form-control" name="kode" value="<?= $airline['code'] ?>" required>
                              </div>
                              <div class="form-group">
