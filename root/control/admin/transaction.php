...
$app->route(['url' => '/admin/transaksi', 'method' => 'get', 'middleware' => 'admin'], function () use ($app) {
  ...
  return page('admin.transaction.index');
});

$app->route(['url' => '/admin/transaksi/laporan', 'method' => 'get', 'middleware' => 'admin'], function () use ($app) {
  if (isset($_GET['tanggal'])) {
    ...
    return page('admin.transaction.report');
  } else {
